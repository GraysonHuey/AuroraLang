...
My next step is to add a couple more commands to this language, and then I'll probably convert the Python version into a C/C++ implementation. Then, I'll start working on creating a compiled language using C/C++ (idk which one yet)
<br></br>
<br></br>
# Quick Reference
